...
class DashboardController extends Controller
{
    public function index(Request $req)
    {
        ...
        if($lokasinama != 5 && !$user->hasRole(['Pimpinan'])) {
            ...
            return view('dashboard.dashboardpimpinan', compact('lokasis', 'jumlahpenjualan', 'pemasukan', 'batalpenjualan', 'returpenjualan', 'penjualanbaru', 'penjualanlama', 'jumlahpembalian', 'pemasukan', 'batalpembelian', 'returpembelian', 'pembelianbaru', 'pembelianlama', 'pengeluaran', 'rekenings', 'balance'));
        }else{
            if ($user->hasRole(['Purchasing'])) {
                $lokasiId = $karyawan->lokasi->id;
            } else {
