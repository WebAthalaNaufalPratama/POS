                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                <span class="input-group-text" id="inputGroupPrepend2">
                                                    <input type="checkbox" id="cek_point" name="cek_point" {{ $penjualans->point_dipakai != 0 ? 'checked' : '' }} disabled>
                                                </span>
                                                <input type="number" class="form-control" id="point_dipakai" name="point_dipakai" placeholder="0" value="{{ $penjualans->point_dipakai }}" aria-describedby="inputGroupPrepend2" required disabled>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group">
                                            <div id="alasan" style="display: none;">
                                                ...
                                                <textarea name="alasan" id="alasan" disabled>{{$penjualans->alasan}}</textarea>
                                            </div>
                                        </div>
                                    </div>
                                            ...
                                            <tbody id="dynamic_field">
                                                @if(count($produks) < 1) <tr>
                                                    ...
                                                    <td><select id="jenis_diskon_0" name="jenis_diskon[]" class="form-control" onchange="showInputType(0)">
                                                            ...
                                                            <option value="Nominal" {{ $penjualans->jenis_diskon_0 == 'Nominal' ? 'selected' : ''}}>Nominal</option>
                                                            <option value="persen" {{ $penjualans->jenis_diskon_0 == 'persen' ? 'selected' : ''}}>Persen</option>
                                                        </select>
                                                    ...
                                                    <tr>
                                                        <td>
                                                        <select id="nama_produk_{{ $i }}" name="nama_produk[]" class="form-control" onchange="updateHargaSatuan(this)" disabled>
                                                            <option value="">Pilih Produk</option>
                                                            @foreach ($produkjuals as $produk)
                                                                <option 
                                                                    value="{{ $produk->kode }}" 
                                                                ...
                                                                >
                                                                    @if (substr($produk->kode, 0, 3) === 'TRD')
                                                                        ...
                                                                        @foreach ($produk->komponen as $komponenItem)
                                                                            @if ($komponenItem->kondisi)
                                                                                @foreach($kondisis as $kondisi)
                                                                                    @if($kondisi->id == $komponenItem->kondisi)
                                                                                        - {{ $kondisi->nama }}
                                                                                        @php 
                                                                                            $found = true; 
                                                                                            break; 
                                                        ...
                                                        <td><input type="text" name="harga_satuan[]" id="harga_satuan_{{ $i }}" class="form-control" value="{{ 'Rp '. number_format($komponen->harga, 0, ',', '.',) }}" onchange="calculateTotal(0)" disabled></td>
                                                        ...
                                                        <td><select id="jenis_diskon_{{ $i }}" name="jenis_diskon[]" class="form-control" onchange="showInputType({{ $i }})" disabled>
                                                                <option value="0">Pilih Diskon</option>
                                                            ...
                                                            <div>
                                                                <div class="input-group">
                                                                    <input type="text" name="diskon[]" id="diskon_{{ $i }}" value="{{ $komponen->diskon}}" style="display:none;" class="form-control" aria-label="Recipient's username" aria-describedby="basic-addon3" onchange="calculateTotal(0)" disabled>
                                                                    <span class="input-group-text" id="nominalInput_0" style="display: none;">.00</span>
                                                                    <span class="input-group-text" id="persenInput_0" style="display: none;">%</span>
                                                                </div>
                                                            </div>
                                                        ...
                                                        <td><input type="text" name="harga_total[]" id="harga_total_{{ $i }}" class="form-control" value="{{ 'Rp '. number_format($komponen->harga_jual, 0, ',', '.',)}}" disabled></td>
                                                        @php
                                                            $user = Auth::user();
                                        ...
                                        <div class="row mt-4">
                                            ...
                                            <div class="col-lg-6">
                                                ...
                                                <div class="form-group" style="display:none;">
                                                    <label for="no_invoice">Nomor Invoice</label>
                                                    <input type="text" class="form-control" id="no_invoice_bayar" name="no_invoice_bayar" placeholder="Nomor Invoice" onchange="generateInvoiceBayar(this)" readonly disabled>
                                                </div>
                                                <div class="form-group mt-3">
                                                    <div id="inputPembayaran" style="display: none;">
                                                        <label for="nominal">Nominal</label>
                                                        <input type="text" class="form-control" id="nominal" name="nominal" value="" placeholder="Nominal Bayar" readonly disabled>
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                            ...
                                            <ul>
                                                ...
                                                <li>
                                                    <h4><select id="jenis_ppn" name="jenis_ppn" class="form-control" required disabled>
                                                        ...
                                                        <h5 class="col-lg-5">
                                                            <div class="input-group">
                                                                <input type="text" id="persen_ppn" name="persen_ppn" value="{{ $penjualans->persen_ppn}}" class="form-control" required disabled>
                                                                <span class="input-group-text">%</span>
                                                            </div>
                                                            <input type="text" id="jumlah_ppn" name="jumlah_ppn" value="{{ 'Rp '. number_format($penjualans->jumlah_ppn, 0, ',', '.',)}}" class="form-control" readonly required disabled>
                                                        </h5>
                                                </li>
                                                <li>
                                                    <h4>Promo</h4>
                                                    <h5 class="col-lg-5">
                                                        ...
                                                        <input type="text" class="form-control" required name="total_promo" id="total_promo" value="{{ 'Rp '. number_format($penjualans->total_promo, 0, ',', '.',) }}" readonly disabled>
                                                    </h5>
                                                </li>
                                                <li>
                                                    <h4>Biaya Ongkir</h4>
                                                ...
                                                <li class="total">
                                                    <h4>Total Tagihan</h4>
                                                    <h5><input type="text" id="total_tagihan" name="total_tagihan" class="form-control" value="{{ 'Rp '. number_format($penjualans->total_tagihan, 0, ',', '.',)}}" required disabled></h5>
                                                </li>
                                                <li>
                                                    <h4>Sisa Bayar</h4>
                                                    <h5><input type="text" id="sisa_bayar" name="sisa_bayar" class="form-control" value="{{ 'Rp '. number_format($penjualans->sisa_bayar, 0, ',', '.',)}}"  required disabled></h5>
                                                </li>
                                            </ul>
                                        </div>
                                    </div>
