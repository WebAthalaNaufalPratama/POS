...
<body>
    <div class="header">
        ...
        <table class="full-width">
            <tr>
                <td class="text-center"><small>{{ $produk_terjual['penjualan']['lokasi']['alamat'] }}</small></td>
            </tr>
            <tr>
    ...
    <div class="content">
        <table class="full-width">
            ...
            <tr>
                ...
                <td style="width: 20%" class="text-start">: {{ $produk_terjual['penjualan']['no_invoice'] }}</td>
            </tr>
            <tr>
        ...
        <div class="ttd">
            <div class="pihak-pertama">
                ...
                <br>
                <br>
                <p><strong>{{ $produk_terjual['penjualan']['karyawan']['nama'] }}</strong></p>
