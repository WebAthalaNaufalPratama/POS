        ...
        <table style="border-collapse: collapse; width: 100%;">
            <tbody>
                ...
                <tr>
                    ...
                    <td style="border: 1px solid #ddd; padding: 8px;">{{ NumberToWords($penjualan->sum('total_tagihan')) }}</td>
                </tr>
                <tr>
                        ...
                        <table style="border-collapse: collapse; width: 100%;">
                            ...
                            <tbody>
                                @foreach ($penjualan as $jual)
                                    @foreach ($produkterjual->where('no_invoice', $jual->no_invoice) as $item)
                                        <tr>
                                            <td style="border: 1px solid #ddd; padding: 8px;">{{ $jual->tanggal_invoice }}</td>
                                            <td style="border: 1px solid #ddd; padding: 8px;">{{ $jual->no_invoice }}</td>
                                            <td style="border: 1px solid #ddd; padding: 8px;">{{ $item->produk->nama }}</td>
                                            <td style="border: 1px solid #ddd; padding: 8px;">{{ $item->jumlah }}</td>
                                            <td style="border: 1px solid #ddd; padding: 8px;">{{ number_format($item->harga_jual, 0, ',', '.') }}</td>
                                        </tr>
                                    @endforeach
                                @endforeach
                            </tbody>
                            <tfoot>
                                <tr>
                                    ...
                                    <td style="border: 1px solid #ddd; padding: 8px;">{{ number_format($penjualan->sum('total_tagihan'), 0, ',', '.') }}</td>
                                </tr>
                            </tfoot>
                        </table>
                    </td>
