                ...
                <div class="row mb-2">
                    <row class="col-lg-12 col-sm-12">
                        <div class="row">
                            ...
                            <div class="col-lg col-sm-6 col-12">
                                <a href="javascript:void(0);" id="filterBtn" data-base-url="{{ route('laporan.pembelian') }}" class="btn btn-info">Filter</a>
                                <a href="javascript:void(0);" id="clearBtn" data-base-url="{{ route('laporan.pembelian') }}" class="btn btn-warning">Clear</a>
                            </div>
                        </div>
                    </row>
                </div>
    ...
    <script>
        ...
        function pdf(){
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    var url = "{{ route('laporan.pembelian-pdf') }}" + '?' + $.param({
        ...
        function excel(){
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    var url = "{{ route('laporan.pembelian-excel') }}" + '?' + $.param({
                        supplier: filterSupplier,
                        gallery: filterGallery,
                        dateStart: filterDateStart,
                        dateEnd: filterDateEnd,
