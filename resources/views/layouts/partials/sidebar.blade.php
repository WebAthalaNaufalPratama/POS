            ...
            <ul>
                @php
                    ...
                    if($user->hasRole(['AdminGallery', 'KasirGallery'])) {
                        ...
                        $hitungmutasigg = \App\Models\Mutasi::where('no_mutasi', 'LIKE', 'MGG%')->where('status', 'DIKONFIRMASI')->where('penerima', $lokasi->lokasi_id)->whereNull('diperiksa_id')->count();
                        ...
                        $hitungmutasigg = \App\Models\Mutasi::where('no_mutasi', 'LIKE', 'MGG%')->where('status', 'DIKONFIRMASI')->where('penerima', $lokasi->lokasi_id)->whereNull('dibukukan_id')->count();
