                            ...
                            <div class="row justify-content-around">
                                ...
                                <div class="col-md-4 border rounded mt-3 pt-3">
                                    ...
                                    <div class="form-group row mt-1">
                                        ...
                                        <div class="col-lg-9">
                                            <div class="input-group">
                                                <input type="number" id="ppn_persen" name="ppn_persen" value="{{ $data->kontrak->ppn_persen ?? 11 }}" class="form-control" aria-label="Recipient's username" aria-describedby="basic-addon3" required>
                                    ...
                                    <div class="form-group row mt-1">
                                        ...
                                        <div class="col-lg-9">
                                            <div class="input-group">
                                                <input type="number" id="pph_persen" name="pph_persen" value="{{ $data->kontrak->pph_persen ?? 2 }}" class="form-control" aria-label="Recipient's username" aria-describedby="basic-addon3" required>
                                                <span class="input-group-text" id="basic-addon3">%</span>
                                            </div>
...
@section('scripts')
    <script>
        ...
        function total_harga() {
            ...
            var sudah_terbayar = $('#sudah_terbayar').val();
            $('#sisa_bayar').val(formatNumber((harga_total - sudah_terbayar)))
        }
        function ppn(){
