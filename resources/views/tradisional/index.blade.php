            ...
            <div class="table-responsive">
                <div class="row mb-2">
                    <div class="col-12 d-flex justify-content-between align-items-center">
                        ...
                        <div class="col-auto">
                        @if(in_array('tradisional.pdf', $thisUserPermissions))
                        ...
                        @endif
                        @if(in_array('tradisional.excel', $thisUserPermissions))
...
@section('scripts')
    ...
    function pdf() {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                var url = "{{ route('tradisional.pdf') }}" + '?' + $.param({
    ...
    function excel() {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                var url = "{{ route('tradisional.excel') }}" + '?' + $.param({
                    // produk: filterNamaProduk,
                    // tipe_produk: filterTipeProduk,
                    // satuan: filterSatuan,
                });
