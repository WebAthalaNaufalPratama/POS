                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                ...
                                <ul class="dropdown-menu">
                                    ...
                                    <li>
                                        <a href="{{ route('kontrak.pdfKontrak', ['kontrak' => $kontrak->id]) }}" target="_blank" class="dropdown-item"><img src="assets/img/icons/reverse-alt.svg" class="me-2" alt="img">Pergantian</a>
                                    </li>
                                    <li>
