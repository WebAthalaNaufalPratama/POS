    ...
    <div class="col-sm-12">
        <div class="card">
            <div class="card-header">
                <h5 class="card-title">Edit Produk Gift</h5>
            </div>
            <div class="card-body">
                <div class="row">
                    <div class="col-sm">
                        <form id="editForm" action="{{ route('gift.update', ['gift' => $getProdukJual->id]) }}" method="POST">
                            @csrf
                            @method('PATCH')
                                        ...
                                        <tbody id="dynamic_field">
                                            ...
                                            @foreach ($getKomponen as $komponen)
                                                <tr id="row{{ $i }}">
                                                    ...
                                                    <td><input type="text" name="jumlah[]" id="jumlah_{{ $i }}" value="{{ $komponen->jumlah }}" oninput="multiply(this)" class="form-control" required></td>
