            ...
            <div class="table-responsive">
                <div class="row mb-2">
                    <div class="col-12 d-flex justify-content-between align-items-center">
                      ...
                      <div class="col-auto">
                        @if(in_array('inven_gudang.ubahKondisi', $thisUserPermissions))
                        ...
                        @foreach ($riwayat as $item)
                            ...
                            @if($item->jenis === 'Produk Terjual')
                                <tr>
                                    ...
                                    <td>{{ $item->jenis === 'Produk Terjual' || $item->jenis === 'Produk Beli' ? 'Mutasi GH /Pusat' : ($item->jenis === 'Produk Beli' ? 'Purchase Order' : '-') }}</td>
                                    <td>
                                    ...
                                    <td>{{ $item->jenis === 'Produk Terjual' && isset($properties['attributes']['no_mutasigg']) && Str::startsWith($properties['attributes']['no_mutasigg'], 'MPG') ? ($properties['attributes']['jumlah'] ?? '0') : '0' }}</td>
...
<div class="modal fade" id="modalUbahKondisi" tabindex="-1" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="form_ubah_kondisi" action="{{ route('inven_gudang.ubahKondisi') }}" method="POST">
                    @csrf
                    <div class="table-responsive">
                        <table class="table">
                            <thead>
        ...
        $(document).ready(function(){
            ...
            // Start Datatable Inventory
                        ...
                        render: function(data, type, row) {
                            return `
                                <div class="text-center">
                                    ...
                                    <ul class="dropdown-menu">
                                        <li>
                                            <a href="inven_gudang/${row.id}/show" class="dropdown-item"><img src="assets/img/icons/eye1.svg" class="me-2" alt="img">Detail</a>
                                        </li>
                                        <li>
                                            <a href="inven_gudang/${row.id}/edit" class="dropdown-item"><img src="assets/img/icons/edit.svg" class="me-2" alt="img">Edit</a>
                                        </li>
                                    </ul>
                                </div>
                            `;
                ...
                let table = initDataTable('#inventory', {
                    ajaxUrl: "{{ route('inven_gudang.index') }}",
                    columns: columns,
                    order: [[2, 'asc']],
                    searching: true,
                    lengthChange: true,
