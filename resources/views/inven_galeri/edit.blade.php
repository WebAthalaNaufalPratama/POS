...
<div class="row">
    <div class="col-sm-12">
        <div class="card">
            ...
            <div class="card-body">
                <form id="form_perangkai" action="{{ route('inven_galeri.update', ['inven_galeri' => $data->id]) }}" method="POST">
                    @csrf
                    @method('patch')
                    <div class="row">
                        <div class="col-sm-4">
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            ...
                            <input type="number" class="form-control" name="jumlah" id="jumlah" value="{{ $data->jumlah }}" oninput="validateMinZero(this, 10000)" required>
                        </div>
                        <div class="col-sm-6">
                            <label for="min_stok" class="col-form-label">Minimal Stok</label>
                            <input type="number" class="form-control" name="min_stok" id="min_stok" value="{{ $data->min_stok }}" oninput="validateMinZero(this, 100)" required>
                        </div>
                    </div>
