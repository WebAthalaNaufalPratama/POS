                                        ...
                                        <table class="table">
                                            ...
                                            <tbody id="dynamic_field">
                                                ...
                                                <tr>
                                                    ...
                                                    <td><input type="number" name="qtytrm[]" id="qtytrm_0" oninput="multiply($(this))" class="form-control" onchange="calculateTotal(0)" value="{{ $item->produkretur ? ($item->jml_diterima + $item->produkretur->jumlah ) : '' }}" readonly></td>
